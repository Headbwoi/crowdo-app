...
function HeroSection() {
  return (
    <section className="flex items-center flex-col font-commissioner container  text-center gap-20 px-5 pt-14 md:pt-60 lg:w-3/4 relative z-30 overflow-hidden">
      <div>
